...
module Setting
  TABLE_SIZE = 4; # 5x5 grid as tables start from zero
  ...
  ERROR_MSG = {
    ...
    invalid_command: "Invalid command. Valid commands are: PLACE <0-#{TABLE_SIZE}>, <0-#{TABLE_SIZE}>, <NORTH|SOUTH|EAST|WEST> | MOVE | LEFT | RIGHT | REPORT",
  ...
  def print_instructions
    ...
    puts "\tPLACE <0-#{TABLE_SIZE}>, <0-#{TABLE_SIZE}>, <NORTH|SOUTH|EAST|WEST>"
    puts "\tMOVE"
    puts "\tLEFT"
    puts "\tRIGHT"
    puts "\tREPORT"
